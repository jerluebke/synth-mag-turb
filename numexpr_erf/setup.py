...
with open('numexpr_erf/version.py', 'w') as fh:
...
clibs = []
def_macros = []
sources = ['numexpr_erf/interpreter.cpp',
           'numexpr_erf/module.cpp',
           'numexpr_erf/numexpr_object.cpp']
extra_cflags = []
extra_link_args = []
...
if platform.uname().system == 'Windows':
    ...
    if "MSC" in platform.python_compiler():
        extra_cflags = ['/O2']
    extra_link_args = []
    sources.append('numexpr_erf/win32/pthread.c')
else:
    extra_cflags = []
    extra_link_args = []
